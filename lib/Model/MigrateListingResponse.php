...
class MigrateListingResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'inventory_items' => '\OpenAPI\Client\Model\InventoryItemListing[]',
        'listing_id' => 'string',
     ...
     * Sets errors
     *
     * @param \OpenAPI\Client\Model\Error[]|null $errors If one or more errors occur with the attempt to migrate the listing, this container will be returned with detailed information on each error.
     *
     * @return $this
     */
     ...
     *
     * @return \OpenAPI\Client\Model\InventoryItemListing[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\InventoryItemListing[]|null $inventory_items This container exists of an array of SKU values and offer IDs. For single-variation listings, this will only be one SKU value and one offer ID (if listing was successfully migrated), but multiple SKU values and offer IDs will be returned for multiple-variation listings.
     *
     * @return $this
     */
     ...
     * Sets warnings
     *
     * @param \OpenAPI\Client\Model\Error[]|null $warnings If one or more warnings occur with the attempt to migrate the listing, this container will be returned with detailed information on each warning. It is possible that a listing can be successfully migrated even if a warning occurs.
     *
     * @return $this
     */
