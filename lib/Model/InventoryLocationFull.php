...
class InventoryLocationFull implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'location' => '\OpenAPI\Client\Model\LocationDetails',
     ...
     * Gets location
     *
     * @return \OpenAPI\Client\Model\LocationDetails|null
     */
     ...
     * Sets location
     *
     * @param \OpenAPI\Client\Model\LocationDetails|null $location location
     *
     * @return $this
     */
     ...
     *
     * @param \OpenAPI\Client\Model\OperatingHours[]|null $operating_hours Although not technically required, this container is highly recommended to be used to specify operating hours for a store inventory location. This container is used to express the regular operating hours for a store location during each day of the week. A dayOfWeekEnum field and an intervals container will be needed for each day of the week that the store location is open.
     *
     * @return $this
     */
     ...
     * Sets special_hours
     *
     * @param \OpenAPI\Client\Model\SpecialHours[]|null $special_hours This container is used to express the special operating hours for a store inventory location on a specific date, such as a holiday. The special hours specified for the specific date will override the normal operating hours for that particular day of the week.
     *
     * @return $this
     */
