...
class PriceQuantityResponse implements ModelInterface, ArrayAccess
{
     ...
     * Sets errors
     *
     * @param \OpenAPI\Client\Model\Error[]|null $errors This array will be returned if there were one or more errors associated with the update to the offer or inventory item record.
     *
     * @return $this
     */
     ...
     * Sets warnings
     *
     * @param \OpenAPI\Client\Model\Error[]|null $warnings This array will be returned if there were one or more warnings associated with the update to the offer or inventory item record.
     *
     * @return $this
     */
