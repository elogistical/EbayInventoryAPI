...
class InventoryItems implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'href' => 'string',
        'inventory_items' => '\OpenAPI\Client\Model\InventoryItemWithSkuLocaleGroupid[]',
        'limit' => 'int',
        'next' => 'string',
        'prev' => 'string',
        'size' => 'int',
     ...
     *
     * @return \OpenAPI\Client\Model\InventoryItemWithSkuLocaleGroupid[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\InventoryItemWithSkuLocaleGroupid[]|null $inventory_items This container is an array of one or more inventory items, with detailed information on each inventory item.
     *
     * @return $this
     */
