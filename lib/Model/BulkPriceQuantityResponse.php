...
class BulkPriceQuantityResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'responses' => '\OpenAPI\Client\Model\PriceQuantityResponse[]'
    ];
     ...
     * Gets responses
     *
     * @return \OpenAPI\Client\Model\PriceQuantityResponse[]|null
     */
     ...
     * Sets responses
     *
     * @param \OpenAPI\Client\Model\PriceQuantityResponse[]|null $responses This container will return an HTTP status code, offer ID, and SKU value for each offer/inventory item being updated, as well as an errors and/or warnings container if any errors or warnings are triggered while trying to update those offers/inventory items.
     *
     * @return $this
     */
