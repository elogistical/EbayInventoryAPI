...
class ShippingCostOverride implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'additional_shipping_cost' => '\OpenAPI\Client\Model\Amount',
        'priority' => 'int',
        'shipping_cost' => '\OpenAPI\Client\Model\Amount',
        'shipping_service_type' => 'string',
        'surcharge' => '\OpenAPI\Client\Model\Amount'
    ];
     ...
     *
     * @param \OpenAPI\Client\Model\Amount|null $additional_shipping_cost additional_shipping_cost
     *
     * @return $this
     */
     ...
     * Sets surcharge
     *
     * @param \OpenAPI\Client\Model\Amount|null $surcharge surcharge
     *
     * @return $this
     */
