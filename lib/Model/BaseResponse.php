...
class BaseResponse implements ModelInterface, ArrayAccess
{
     ...
     * Sets warnings
     *
     * @param \OpenAPI\Client\Model\Error[]|null $warnings This container will be returned in a call response payload if one or more warnings or errors are triggered when an Inventory API call is made. This container will contain detailed information about the error or warning.
     *
     * @return $this
     */
