...
> \OpenAPI\Client\Model\InventoryLocationResponse getInventoryLocation($merchant_location_key)
...
> \OpenAPI\Client\Model\LocationResponse getInventoryLocations($limit, $offset)
