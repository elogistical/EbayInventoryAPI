# OpenAPI\Client\InventoryItemGroupApi
...
> \OpenAPI\Client\Model\BaseResponse createOrReplaceInventoryItemGroup($inventory_item_group_key, $content_language, $inventory_item_group)
...
$apiInstance = new OpenAPI\Client\Api\InventoryItemGroupApi(
...
$inventory_item_group = new \OpenAPI\Client\Model\InventoryItemGroup(); // \OpenAPI\Client\Model\InventoryItemGroup | Details of the inventory Item Group
 ...
 **inventory_item_group** | [**\OpenAPI\Client\Model\InventoryItemGroup**](../Model/InventoryItemGroup.md)| Details of the inventory Item Group |
...
> \OpenAPI\Client\Model\InventoryItemGroup getInventoryItemGroup($inventory_item_group_key)
...
[**\OpenAPI\Client\Model\InventoryItemGroup**](../Model/InventoryItemGroup.md)
